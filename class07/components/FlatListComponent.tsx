...
// TypeScript interface for type safety of product items
interface Product {
  image: string;
  name: string;
  rating: number;
...
// Main component that renders a large list using FlatList
const HugeList = () => {
  // Array of product objects (sample data)
  const products = [
    {
      image: "https://picsum.photos/100/300?random=1",
      name: "Product 1",
      rating: 4.5,
      price: 29.99,
    },
  ...
  //   // renderItem function extracted to avoid inline function inside FlatList
  ...
  return (
    // FlatList is used to efficiently render large lists
    <FlatList
      data={products}
...
// Styles for the product card UI
